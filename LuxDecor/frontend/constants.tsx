...
// import { Product, DiscountCode } from './src/types/types';
...
//     rating: 4.8,
//     reviews: [
//       { id: 1, rating: 5, comment: 'Sofa cực kỳ êm, màu sắc sang trọng hơn cả trong hình. Giao hàng rất đúng hẹn.', createdAt: '15/02/2024' },
//       { id: 2, rating: 4, comment: 'Chất lượng tốt, tuy nhiên mình phải chờ lâu hơn dự kiến 1 ngày.', createdAt: '10/02/2024' }
//     ]
//   },
//   {
//     id: 2,
...
//     images: ['https://bizweb.dktcdn.net/100/391/155/files/td696.png?v=1634867906143?auto=format&fit=crop&q=80&w=800'],
...
//     rating: 4.9,
//     reviews: [
//       { id: 3, rating: 5, comment: 'Đá marble vân rất đẹp, chân bàn cực kỳ chắc chắn. Rất hài lòng.', createdAt: '20/01/2024' }
//     ]
//   },
//   {
//     id: 3,
...
//     rating: 5.0,
//     reviews: [
//       { id: 4, rating: 5, comment: 'Ngồi cực kỳ thoải mái, da thật sờ rất sướng tay. Đúng là tiền nào của nấy.', createdAt: '12/12/2023' }
//     ]
//   },
//   {
//     id: 5,
...
//     images: ['https://m.media-amazon.com/images/I/81a-oJGw2-L._AC_UF894,1000_QL80_.jpg?auto=format&fit=crop&q=80&w=800'],
...
//     rating: 4.9,
//     reviews: [
//       { id: 5, rating: 5, comment: 'Giường chắc chắn, thiết kế tối giản đúng ý mình.', createdAt: '05/02/2024' }
//     ]
//   }
// ];

// const CATEGORIES = ['Tất cả', 'Phòng khách', 'Phòng ngủ', 'Phòng ăn', 'Văn phòng', 'Trang trí'];

// export { PRODUCTS, CATEGORIES, DISCOUNT_CODES };