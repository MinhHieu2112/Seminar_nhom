...
const OrderSummary = () => {
  ...
  const checkOut = async () => {
    const deliveryCost = deliveryType === "Standard" ? 5 : 10;
    const payload = {
      DeliveryType: deliveryType,
      DeliveryTypeCost: deliveryCost,
      costAfterDelieveryRate: state.cartTotal + deliveryCost,
      promo_code: "",
      phoneNumber: phone,
            ...
            <button
                ...
                onClick={async () => {
                  if (phone.length > 0) {
                    ...
                    if (success && paymentMethod !== "VNPAY") {
